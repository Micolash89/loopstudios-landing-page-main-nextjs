...
export default function Home() {
  return (
    <div className={`${josefin_Sans.className} min-h-screen flex flex-col  mx-auto w-full`}>
      ...
      <h1 className="uppercase text-4xl sm:text-6xl border border-white p-5 w-fit sm:max-w-[30rem] text-balance  text-left justify-self-start mx-5">Immersive experiences that deliver</h1>
